...
import com.victorem.zamzamchains.api.support.CreditDebitResponse;
import com.victorem.zamzamchains.api.support.DebitSupport;
...
public class DefaultDebitRepository {
	...
	public CreditDebitResponse addDebitRecord(DebitSupport debitSupport) {
		try {
			...
			String tableNameCredit = debitSupport.getClientName() + "_Credit";
			String tableNameDebit = debitSupport.getClientName() + "_Debit";
